    ...
    fn validate_notify_event_request() {
        let test = NotifyEventRequest::<100> {
            ...
            event_data: vec![EventDataType {
                ...
                cause: Some(0),
                actual_value: "",
                tech_code: Some("tech_code"),
                tech_info: Some("tech_info"),
                cleared: Some(false),
                transaction_id: Some("transaction_id"),
    ...
    fn validate_set_network_profile_request() {
        let test = SetNetworkProfileRequest {
            ...
            connection_data: NetworkConnectionProfileType {
                ...
                apn: Some(APNType {
                    apn: "apn",
                    apn_user_name: Some("apn_user_name"),
                    apn_password: Some("apn_password"),
                    sim_pin: Some(1),
                    preferred_network: Some("6chars"),
