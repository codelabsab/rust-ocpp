use crate::v2_0_1::core::{
    datatypes::{composite_schedule_type::CompositeScheduleType, status_info_type::StatusInfoType},
    enumerations::{
        charging_rate_unit_enum_type::ChargingRateUnitEnumType,
        generic_status_enum_type::GenericStatusEnumType,
    },
};
