use crate::v2_0_1::core::{
    datatypes::{charging_needs_type::ChargingNeedsType, status_info_type::StatusInfoType},
    enumerations::notify_ev_charging_needs_status_enum_type::NotifyEVChargingNeedsStatusEnumType,
};
