...
/// A ChargingProfile consists of ChargingSchedule, describing the amount of power or current that can be delivered per time interval.
///
/// ChargingProfileCriterionType is used by: get_charging_profiles [GetChargingProfilesRequest](`crate::messages::get_charging_profiles::GetChargingProfilesRequest`)
