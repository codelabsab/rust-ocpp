...
pub struct SendLocalListRequest<'a, const LOCAL_AUTHORIZATION_LIST_SIZE: usize, const N_EVSE_IDS: usize, const TOKEN_N_ADDITIONAL_INFOS: usize> {
    pub version_number: i64,
    pub update_type: UpdateEnumType,
    #[serde(skip_serializing_if = "Option::is_none",borrow)]
    pub local_authorization_list: Option<Vec<AuthorizationData<'a, N_EVSE_IDS, TOKEN_N_ADDITIONAL_INFOS>, LOCAL_AUTHORIZATION_LIST_SIZE>>,
}
...
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq, Default)]
#[serde(rename_all = "camelCase")]
pub struct SendLocalListResponse<'a> {
