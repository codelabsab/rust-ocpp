...
/// A message sent by the Charging Station to the CSMS when booting.
...
/// Message sent by the CSMS to the Charging Station in response to a [`BootNotificationRequest`].
#[derive(serde::Serialize, serde::Deserialize, Debug, Clone, PartialEq)]
#[serde(rename_all = "camelCase")]
