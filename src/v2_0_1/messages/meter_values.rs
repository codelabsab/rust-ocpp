...
pub struct MeterValuesRequest<'a, const N_SAMPLED_VALUES: usize, const N_METER_VALUES: usize> {
    /// This contains a number (>0) designating an EVSE of the Charging Station. ‘0’ (zero) is used to designate the main power meter.
    pub evse_id: i64,
    /// The sampled meter values with timestamps.
    #[serde(borrow)]
    pub meter_value: Vec<MeterValueType<'a, N_SAMPLED_VALUES>, N_METER_VALUES>,
}
