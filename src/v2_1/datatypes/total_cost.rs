...
mod tests {
    ...
    fn test_with_methods() {
        ...
        let total = TotalPriceType::new(100.0);
        let cost = 100.0;
        let fixed = PriceType::new(10.0, false);
        let energy = PriceType::new(50.0, false);
        let charging_time = PriceType::new(20.0, false);
        let idle_time = PriceType::new(5.0, false);
        let reservation_time = PriceType::new(5.0, false);
        let reservation_fixed = PriceType::new(10.0, false);
