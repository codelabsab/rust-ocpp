...
impl TariffConditionsFixedType {
    /// Creates a new `TariffConditionsFixedType` with required fields.
    ///
    /// # Arguments
    ///
    ...
    /// # Returns
    ///
    /// A new instance of `TariffConditionsFixedType` with optional fields set to `None`
...
mod tests {
    ...
    fn test_new_tariff_conditions_fixed() {
        let price = 10.0;
        let tariff_conditions_fixed = TariffConditionsFixedType::new(price);

        assert_eq!(tariff_conditions_fixed.price(), price);
        assert_eq!(tariff_conditions_fixed.price_excl_tax(), None);
        assert_eq!(tariff_conditions_fixed.price_incl_tax(), None);
    ...
    fn test_setter_methods() {
        ...
        let mut tariff_conditions_fixed = TariffConditionsFixedType::new(price1);
