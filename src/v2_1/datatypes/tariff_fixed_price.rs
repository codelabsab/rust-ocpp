...
/// Fixed price component of a tariff.
...
impl TariffFixedPriceType {
    ...
    /// # Arguments
    ///
    /// * `price` - Fixed price per charging session
    ///
    /// # Returns
    ///
    ...
    /// # Arguments
    ///
    /// * `price_excl_tax` - Fixed price per charging session, excluding taxes
    ///
    /// # Returns
    ///
    /// Self reference for method chaining
    ...
    /// # Arguments
    ///
    /// * `price_incl_tax` - Fixed price per charging session, including taxes
    ///
    /// # Returns
    ///
    /// Self reference for method chaining
    ...
    /// # Returns
    ///
    /// An optional fixed price per charging session, excluding taxes
    ...
    /// # Arguments
    ///
    /// * `price_excl_tax` - Fixed price per charging session, excluding taxes, or None to clear
    ///
    /// # Returns
    ///
    /// Self reference for method chaining
    ...
    /// # Returns
    ///
    /// An optional fixed price per charging session, including taxes
    ...
    /// # Arguments
    ///
    /// * `price_incl_tax` - Fixed price per charging session, including taxes, or None to clear
    ///
    /// # Returns
    ///
    /// Self reference for method chaining
...
mod tests {
    ...
    fn test_new_tariff_fixed_price() {
        let price = 10.0;
        let tariff_fixed_price = TariffFixedPriceType::new(price);

        assert_eq!(tariff_fixed_price.price(), price);
        assert_eq!(tariff_fixed_price.price_excl_tax(), None);
        assert_eq!(tariff_fixed_price.price_incl_tax(), None);
    ...
    fn test_with_methods() {
        ...
        assert_eq!(tariff_fixed_price.price(), price);
        assert_eq!(tariff_fixed_price.price_excl_tax(), Some(price_excl_tax));
        assert_eq!(tariff_fixed_price.price_incl_tax(), Some(price_incl_tax));
    ...
    fn test_setter_methods() {
        ...
        let mut tariff_fixed_price = TariffFixedPriceType::new(price1);
        ...
        assert_eq!(tariff_fixed_price.price(), price2);
        assert_eq!(tariff_fixed_price.price_excl_tax(), Some(price_excl_tax));
        assert_eq!(tariff_fixed_price.price_incl_tax(), Some(price_incl_tax));
        assert_eq!(tariff_fixed_price.custom_data(), Some(&custom_data));
